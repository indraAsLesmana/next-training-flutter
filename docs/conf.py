...
# LIVE ReadTheDocs (branch `main`) menampilkan Setup + Session 1 + Session 2 untuk peserta.
# Session 3-4 (materi hari berikutnya) disembunyikan sampai tanggalnya tiba.
...
if not _branch:
    try:
        ...
        _branch = ''
if _branch == 'main':
    exclude_patterns += ['session-3.md', 'session-4.md']
